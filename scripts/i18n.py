...
STRINGS = {
    "en": {
        ...
        "lede_rate": "Ordered by average stars per day since the repository was created.",
    ...
    "vi": {
        ...
        "lede_rate": "Xếp theo số sao trung bình mỗi ngày kể từ khi kho được tạo.",
