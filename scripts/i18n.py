...
STRINGS = {
    "en": {
        ...
        "trending_desc": "GitHub repositories gaining stars fastest over the last {days} day(s).",
        "trending_lede": "Ranked by star growth over {days} days.",
        "window_day": "Today",
    ...
    "vi": {
        ...
        "trending_desc": "Kho GitHub tăng sao nhanh nhất trong {days} ngày qua.",
        "trending_lede": "Xếp theo mức tăng sao trong {days} ngày.",
        "window_day": "Hôm nay",
    ...
    "zh": {
        ...
        "trending_desc": "过去 {days} 天星标增长最快的 GitHub 仓库。",
        "trending_lede": "按 {days} 天内的星标增长排序。",
        "window_day": "今日",
        "window_week": "本周",
        "window_month": "本月",
